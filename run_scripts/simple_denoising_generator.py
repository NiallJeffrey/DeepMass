...
# test_array_wiener = mf.rescale_map(test_array_wiener, scale_ks, 0.5, clip=True)
# train_array_wiener = mf.rescale_map(train_array_wiener, scale_ks, 0.5, clip=True)
...
if plot_results:
    ...
    script_functions.plot_cnn(mf.rescale_map(train_array_clean, scale_wiener, 0.5, clip=True),
                              mf.rescale_map(train_array_noisy, scale_ks, 0.5, clip=True),
                              mf.rescale_map(train_array_wiener, scale_wiener, 0.5, clip=True),
