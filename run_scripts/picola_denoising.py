...
print('loading mask \n')
mask = np.load('../picola_training/Ncov.npy')
mask = np.float32(np.real(np.where(mask>1.0, 1.0, 0.0)))
print(mask.shape)
...
clean_files = [str(os.getcwd()) + '/../picola_training/test_outputs/output_kappa_true.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output1_kappa_true.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output2_kappa_true.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output3_kappa_true.npy']

train_array_clean = script_functions.load_data(clean_files)

train_array_clean = ndimage.gaussian_filter(train_array_clean, sigma=(0,sigma_smooth,sigma_smooth, 0))

print('- loading ks training')
noisy_files = [str(os.getcwd()) + '/../picola_training/test_outputs/output_KS.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output1_KS.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output2_KS.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output3_KS.npy']

train_array_noisy = script_functions.load_data(noisy_files)
...
wiener_files = [str(os.getcwd()) + '/../picola_training/test_outputs/output_wiener.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output1_wiener.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output2_wiener.npy',
               str(os.getcwd()) + '/../picola_training/test_outputs/output3_wiener.npy']


train_array_wiener = script_functions.load_data(wiener_files)
...
## need to make this a random draw
